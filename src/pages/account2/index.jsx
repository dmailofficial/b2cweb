...
const End = () => {
  return (
    <EndWrapper>
      <div className="end-text">If you have any problem on presale, please contact <span>contact@mail.dmail.ai</span> and stay tuned 2nd Presale!</div>
      <br />
...
const Account = () => {
  ...
  const [payShow, setpayShow] = useState(true)
  ...
  const showEnd = ()=> {
    showPop(<End />, '', null, 'The 1st Round Presale Has Ended！', '', null, 'end-pop')
  }
  ...
  const showPop = (text = '', okText = '', okCb = null, name = '', cancelText = '', cancelCb = null, wrapperClass= '') => {
    setpopText(text)
    setpopOkText(okText)
  ...
  return (
    <Web3ReactProvider getLibrary={getLibrary}>
      <Wrapper>
        ...
        <Pop show={popShow} disabled={popDisabled} setShow={setpopShow} text={popText} name={popName} okText={popOkText} okCb={popOkCallback} cancelCb={cancelCallback} cancelText={cancelText} wrapperClass={wrapperClass} />
